...
<table width="400px" cellspacing="0px" border="1px">
    ...
    <tr>
        ...
        <%}%>
        <td>
            <form action="/stu59/DeleteServlet" method="get" onsubmit="return deletes(this.id)">
                <input type="hidden" id="d" value="<%=obj[0]%>" name="sid">
                <input type="submit" value="删除">
            </form>
        </td>
        <td>
            <form action="/stu59/update.jsp" method="get" onsubmit="return updates(this.id)">
...
<h3>点击此处<a href="/stu59/logoutServlet">【注销管理员登录】</a></h3>
</body>
<%} else { %>
<%
